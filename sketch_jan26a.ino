...
#define INFLUXDB_URL "http://192.168.1.28:8086"
#define INFLUXDB_DB_NAME "esp_temp"
#define INFLUX_MEASUREMENT_NAME "room_temperature"
...
void writeToDb() {
  ...
  pointDevice.addField("temperature", readTemperature());
